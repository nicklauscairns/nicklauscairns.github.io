...
*   **Running Tests:** Test scripts are located in the `tests/` directory. Ensure dependencies are installed via `pip install pytest-playwright playwright && playwright install`, then run tests using `pytest tests/`.
