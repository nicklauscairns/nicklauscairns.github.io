...
- [Human Settlement & Migration Simulator](HumanMigrationSettlementSimulator.html) - An interactive map demonstrating how human populations migrate towards natural resources and are displaced by natural hazards and climate change.

### HS-ESS3-2
Evaluate competing design solutions for developing, managing, and utilizing energy and mineral resources based on cost-benefit ratios.*

- [Sustainable Resource Management Simulator](ResourceManagementSimulator.html) - A computational city-builder simulation modeling the cost-benefit ratios of different energy and land management policies.
...
- [Global Climate Impacts & Mitigation Forecast](GlobalClimateImpacts.html) - A computational dashboard allowing users to evaluate different technological solutions (like carbon capture or geoengineering) to mitigate climate impacts.
...
- [Global Climate Impacts & Mitigation Forecast](GlobalClimateImpacts.html) - A computational representation showing how human activity modifies the atmosphere, which in turn modifies the hydrosphere and cryosphere.
