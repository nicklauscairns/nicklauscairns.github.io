...
- [Chemical Reaction Outcomes Predictor](ChemicalReactionsOutcomes.html) - An interactive sandbox to predict outcomes and construct explanations for simple chemical reactions based on valence electrons, featuring progressive challenges and real-world contexts.

  <details>
    <summary><b>Evaluation: Investigative Phenomenon | 4.5/5 Stars | 2026-03-13 11:46:28</b></summary>
    <ul>
      <li>
        <b>Overview:</b> Functions as an investigative sandbox for discovering how valence electrons govern chemical bonding. It presents students with specific atom combinations and real-world contexts, challenging them to figure out the bonding patterns and construct their own explanations for why reactions occur or fail.
      </li>
      <li>
        <b>Dimensional Evaluation & Evidence Statements:</b> Strongly supports the target dimensions. It addresses DCI PS1.B and CCC Patterns by showing how valence electrons dictate bonding ratios. It deeply engages SEP Constructing Explanations by requiring students to write their own rationale based on observations of the simulation, rather than just providing the answer. It fully covers Observable Features 1.a.ii-iii, 2.a.i-iii, and now correctly fulfills 4.a by challenging students to revise their explanations when presented with new, more complex contexts (like moving from NaCl to MgCl2).
      </li>
      <li>
        <b>AI Action Items for Improvement:</b>
        <ul>
          <li><b>Enhance Phenomenon:</b> While the context labels are great, consider adding visual animations of the electron transfer/sharing to make the invisible process more concrete, moving it closer to a 5-star anchoring phenomenon.</li>
        </ul>
      </li>
      <li>
        <b>Implementation Checklist for AI Agent:</b>
        <ul>
          <li>[ ] Animate the electron `div` elements moving from the metal atom's shell to the non-metal's shell during ionic bonding.</li>
          <li>[ ] Draw lines between shared electrons to visualize covalent bonds for molecules like H2O and CH4.</li>
        </ul>
      </li>
    </ul>
  </details>
...
- [Energy Change Computational Model](EnergyChangeModel.html) - An interactive mathematical and computational model for a rollercoaster cart system, balancing kinetic, potential, and thermal energy changes with total energy flow.
